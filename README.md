...
```
For a more detailed example exploring additional aspects such as sampling and approximations, check out the [example notebook](./performance/ksil_example.ipynb).
